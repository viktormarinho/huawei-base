...
export const LandingForm = () => {
    ...
    return (
        <form className="flex flex-col gap-6">
            ...
            <textarea id="message" name="message" placeholder="Message here" value={input.message} onChange={(evt: any) => handleChange(evt)} className="bg-[#F2F2F2] h-[16rem] resize-none p-4 rounded-lg text-xl border-red-500 hover:bg-[#e9e9e9] focus:outline-none focus:rounded-l-none focus:border-l-4" />
