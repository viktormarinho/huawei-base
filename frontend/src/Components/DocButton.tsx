export const DocButton = () => {
    return (
        <a href="google.com" target={"blank"} className="flex items-center space-x-3 text-xl font-bold text-white uppercase py-4 px-10 rounded-2xl select-none button-gradient-animation w-[400px]">
