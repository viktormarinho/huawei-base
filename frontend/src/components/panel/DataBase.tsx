...
import { fetchAllTables } from "../../fetchers/getTables";
...
export const DataBase = () => {
    ...
    const { data, isLoading, error } = useQuery(['tables'], fetchAllTables)
    ...
    return (
        <div className="flex flex-row h-full">
            <DatabaseList tables={data!.tables} selectTable={selectTable} />
            <RowsPanel table={data!.tables[tableSelected]} />
        </div>
    )
}